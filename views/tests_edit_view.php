...
<label>Küsimus</label>
		...
		<option value="3">Multiple responce</option>
		...
		<div id="answer_template">
			...
			<div id="type_id_2" class="answer-template">
				...
				<label>Sisesta vastusevariandid ja märgi milline variant on õige</label>
				<div id="multiple-choice-options">
					...
					<div class="answer-option">
						<input type="radio" name="mc.correct" value="0" >
						<textarea name="mc.answer.0" ></textarea>
					</div>
					<div class="answer-option">
						<input type="radio" name="mc.correct" value="0" >
			...
			<div id="type_id_3" class="answer-template">
				<label>Sistesta vastusevariandid ja märgi ära, millised on õiged </label>
				<div id="multiple-response-answer-option"></div>
				<div class="answer-option">
					<input type="checkbox" name="mr.correct" value="1" >
					<textarea name="mr.answer.0" ></textarea>				<div class="answer-option">
					<input type="checkbox" name="mr.correct" value="1" >
					<textarea name="mr.answer.1" ></textarea>				<div class="answer-option">
					<input type="checkbox" name="mr.correct" value="1" >
					<textarea name="mr.answer.2" ></textarea>				<div class="answer-option">
					<input type="checkbox" name="mr.correct" value="1" >
